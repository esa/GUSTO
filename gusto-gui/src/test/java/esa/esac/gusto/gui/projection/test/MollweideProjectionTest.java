...
import esa.esac.gusto.gui.projection.MollweideProjection;
...
public class MollweideProjectionTest {

    @Test
    public void testConstructors() {
	Quaternion q1 = Attitude.fromDegrees(20,30,40).toQuaternion();
	SkyProjection proj = new MollweideProjection(q1);
	...
	SkyProjection p = new MollweideProjection();
	assertTrue(p.getName().equals("Mollweide"));
    }
    
    @Test
    public void testDefaultViewport() {
	SkyProjection proj = new MollweideProjection();
	double scale = 3;
	proj.setScale(scale);
	...
	// Test too near edge
	Vector3 v4 = new Vector3(Direction.fromDegrees(30, 89.999));
	...
	SkyProjection d = new MollweideProjection();
	String s = d.toString();
	assertFalse(s == null);
