...
import esa.esac.gusto.demo.combined.visibility.MgaConstraint;
 ...
 * @author Jon Brumfitt
 */
public class ScheduleDemo extends SimpleSkyFrame {
	...
	_timeModel = new BoundedTimeModel(schedule.planningPeriod());
	_timeModel.setTimeStep(1000000);
	_view = new SkyPane();
...
//	_mgaConstraint.addChangeListener(_view);
	...
	_timePane = new MyTimePane(_timeModel, schedule);
	...
	SimpleSkyFrame frame = new ScheduleDemo();
	frame.pack();
