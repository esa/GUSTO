 ...
 * @author Jon Brumfitt
 */
public class TimeGuiDemo3 extends JFrame {
	...
	BoundedTimeModel timeModel = new BoundedTimeModel(new TimeInterval(tStart, tStop));
	DemoTimePane2 timePane = new DemoTimePane2(timeModel);
