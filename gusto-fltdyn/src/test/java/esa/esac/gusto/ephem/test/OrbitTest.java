...
/**
 * Test harness for Orbit classes.<p>
 *
 ...
 * the ESOC OASW Fortran library.
 *
 * @author  Jon Brumfitt
 */
public class OrbitTest {

    private static final String OEM_FILE = "data/test.oem";
    private static final String ORBIT_FILE = "data/orbit.dat";
    
    // Tolerance used for comparison with expected result
    private static final double MAX_POS = 1E-5;
    private static final double MAX_VEL = 1E-5;  

    protected static CcsdsOemReader _orbit;
	...
	InputStream is = EphemTest.class.getResourceAsStream(OEM_FILE);
	_orbit = new CcsdsOemReader(is);
	is.close();
    }
	...
	InputStream is = OrbitTest.class.getResourceAsStream(ORBIT_FILE);
	...
	while((line = reader.readLine()) != null) {
	    ...
	    State state = _orbit.interpolate(tdb2000);
	...
	System.out.println("Ran " + ntest + " tests on orbit ephemerides");
